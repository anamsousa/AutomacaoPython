...
navegador.find_element_by_name("titulo").send_keys("A automação é uma coisa boa? (Ana Maria02)")
navegador.find_element_by_name("descripcion").send_keys("Os robôs estão cada vez mais frequentes em nossas vidas..")
navegador.find_element_by_name("creador").send_keys("Ana Maria Curso RPA com python")
navegador.find_element_by_css_selector('input[type="email"]').send_keys("p.anamsousa@gmail.com")
